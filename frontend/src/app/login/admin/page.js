      ...
      <div className="login-card" style={{
        ...
        <form onSubmit={handleSubmit} style={{ width: '100%' }}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <label htmlFor="admin-email" style={{ fontSize: '13px', fontWeight: '600', color: '#374151', display: 'block', marginBottom: '6px' }}>
              Admin Email
            </label>
          ...
          {/* Password */}
          <div style={{ marginBottom: '16px' }}>
            <label htmlFor="admin-password" style={{ fontSize: '13px', fontWeight: '600', color: '#374151', display: 'block', marginBottom: '6px' }}>
              Password
            </label>
            <div style={{ position: 'relative' }}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="#94a3b8"
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
            ...
            <button
              ...
              style={{ background: 'none', border: 'none', padding: 0, fontSize: '13px', color: '#16a34a', fontWeight: '600', cursor: 'pointer' }}>
              Forgot Password?
            </button>
          </div>
