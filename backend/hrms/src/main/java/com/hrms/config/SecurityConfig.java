...
// Production backend and frontend use the same domain.
// Keep this as the HRMS live domain so the chatbot does not call
// the old api.saitejainfotechprivatelimited.com host.
const API_BASE_URL =
